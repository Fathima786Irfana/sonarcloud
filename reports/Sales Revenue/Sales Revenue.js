        ...
        return Object.assign(options, {
            ...
            events: {
                onCheckRow: function (data) {
                    ...
                    // Extract data-doctype attribute correctly
                    const data_doctype = data[2].getAttribute("data-doctype");
                    const tree_type = frappe.query_reports["Sales Revenue"].filters[0].value;
                    if (data_doctype !== tree_type) return;

                    const row_name = data[2].textContent; // Use textContent to get the content of the element
                    const raw_data = frappe.query_report.chart.data;
                    const new_datasets = raw_data.datasets.slice(); // Create a shallow copy of datasets
                    ...
                    if (!element_found) {
                        new_datasets.push({
                            ...
                            values: data
                                ...
                                .map(column => column.textContent), // Use textContent to get the content of the element
                        });
                    }
